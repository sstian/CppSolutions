...
private:
	...
	float maxAbsVi;                   //sumVi2为残差平方和；sigma为标准偏差；
									  //maxAbsVi为残差vi绝对值的最大值；flag=1表示存在系统误差。
};							 
/******************************************************************************
函  数：main()主函数
参  数：
...
int main()
{
	...
	int i;
	float c;		//消除系统误差的因子
	float datum[N]= { 205.3, 204.94, 205.63, 205.24, 206.65, 204.97, 205.36, 205.16, 205.71, 204.70, 204.86, 205.35, 205.21, 205.19, 205.21, 205.32 };
