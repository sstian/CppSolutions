...
// MyExplorerDoc.cpp: CMyExplorerDoc 类的实现
//
...
// CMyExplorerDoc 构造/析构

CMyExplorerDoc::CMyExplorerDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CMyExplorerDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMyExplorerDoc::InitializeSearchContent()
{
...
void CMyExplorerDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
