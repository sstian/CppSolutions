...
{
	line(449, 0, 449, 480);
	TCHAR runTime[] = L"游戏倒计时     : ",
		receiveBallNum[] = L"接到的球的数量:", copyRight[] = L"版权所有:圣石",
		finishWorkDate[] = L"完成日期:2012年12月1日",
		introductiona[] = L"按方向键控制盒子移动接住", introductionb[] = L"小球,倒计时为0时游戏结束";
