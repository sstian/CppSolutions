/************************************************************
*															*
*	程序名称：	Valentine's Day	Fireworks					*
*	编译环境：	VS2017 Professional + EasyX_20190529(beta)	*
*	作者相关：	Sears Saint Tian - 田继辉					*
*	联系方式：	st.tian@foxmail.com							*
*	最后修改：	2020.02.13 Thur.							*
*															*
*************************************************************/
#include <graphics.h>
#include <conio.h>
...
bool ExtractResource(LPCTSTR strDstFile, LPCTSTR strResType, LPCTSTR strResName);	//提取资源，音乐
...
void main()
{
	...
	// 设置窗口标题、位置
	HWND hwnd = GetHWnd();
	SetWindowText(hwnd, L"Kiss: 喜欢温柔善良可爱的你(#^_^#) -- 致亲爱的");
	...
	DWORD stover = timeGetTime();		// 锁死按键计时
...
void welcome()
{
	...
	LPCTSTR strs[] = {
		...
		L"不要忘记，你不是一个人",
		L"与你一起，我会一直陪在你身边",
		L"所有的曾经都是背景，衬托你到来时破晓的黎明",
		L"如流水般清洌，如焰火般灿烂",
		L"---- 小田田 & 小双双 [2020.02.14]"
	};
